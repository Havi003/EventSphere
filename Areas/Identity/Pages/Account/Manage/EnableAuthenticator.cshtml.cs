...
namespace Eventsphere.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        public EnableAuthenticatorModel(
            UserManager<EventsphereUser> userManager,
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(EventsphereUser user)
        {
            ...
            // Generate QR Code
            QrCodeImageData = GenerateQrCodeImage(AuthenticatorUri);
        }
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("EventSphere"),
